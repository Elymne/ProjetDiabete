...
public class ControleurMenu extends ControleurGenerique implements ActionListener, WindowListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(getVue().getjButtonEvaluation())) { accesEvaluation(); }   
        if (e.getSource().equals(getVue().getjButtonListeDiagnostique())) { accesListeDiagnostique(); }     
        if (e.getSource().equals(getVue().getjButtonStatistique())) { accesStatistique(); }
        if (e.getSource().equals(getVue().getjButtonAjoutPatient())) { accesAjoutPatient(); }
    }
